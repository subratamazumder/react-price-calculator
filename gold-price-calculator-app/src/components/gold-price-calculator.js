...
import {MAKING_CHARGES_RATE, GOLD_PRICE_RATE, HM_CHARGES_RATE, MC_DISCOUNT_PRCT} from "./constant" 
class GoldPriceCalculator extends React.Component {
  constructor(props) {
    console.log("GoldPriceCalculator constructing");
    super(props);
    this.state = {
      goldPriceRt: GOLD_PRICE_RATE,
      weight: '',
      makingCharges: MAKING_CHARGES_RATE,
      mcDiscountPrct: MC_DISCOUNT_PRCT,
      totalDiscount: 0.0,
      ...
      totalGST: 0.0,
      totalPriceWGST:0.0,
      totalOtherCharges:HM_CHARGES_RATE
    };
